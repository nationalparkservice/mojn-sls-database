...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Camera memory cards, each with a unique identifier', @level0type = N'SCHEMA', @level0name = N'ref', @level1type = N'TABLE', @level1name = N'CameraCard';
