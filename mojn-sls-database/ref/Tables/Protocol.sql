CREATE TABLE [ref].[Protocol] (
    ...
    [CreatedBy]               VARCHAR (50)  CONSTRAINT [DF_Protocol_CreatedBy] DEFAULT (suser_sname()) NOT NULL,
    [DateCreated]             DATETIME2 (0) CONSTRAINT [DF_Protocol_DateCreated] DEFAULT (getdate()) NOT NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Date the record was created', @level0type = N'SCHEMA', @level0name = N'ref', @level1type = N'TABLE', @level1name = N'Protocol', @level2type = N'COLUMN', @level2name = N'DateCreated';
