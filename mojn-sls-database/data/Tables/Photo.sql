...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Photos taken at the spring', @level0type = N'SCHEMA', @level0name = N'data', @level1type = N'TABLE', @level1name = N'Photo';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Foreign key to ref.PhotoShortDescription (short descriptions of photos, used for file naming)', @level0type = N'SCHEMA', @level0name = N'data', @level1type = N'TABLE', @level1name = N'Photo', @level2type = N'COLUMN', @level2name = N'PhotoShortDescriptionID';
